                    ...
                    <div class="login_form_inner">
                        ...
                        <form class="row login_form" action="" method="post" id="contactForm" novalidate="novalidate">
                            ...
                            <div class="col-md-12 form-group">
                                <input type="text" class="form-control" id="name" name="name" placeholder="Name" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Username'" style="<?php echo empty($nameError) ? "" : "border: 1px solid red" ?>">
                            </div>

                            <div class="col-md-12 form-group">
                                <input type="email" class="form-control" id="email" name="email" placeholder="Email" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Email'" style="<?php echo empty($emailError) ? "" : "border: 1px solid red;" ?>">
                            </div>
                            ...
                            <div class="col-md-12 form-group">
                                ...
                                <a href="login.php" class="btn btn-link"><i class="fa fa-arrow-left" aria-hidden="true"></i>Login</a>
                            </div>
                        </form>
                    </div>
                </div>
