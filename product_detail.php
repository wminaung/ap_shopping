    ...
    <div class="row s_product_inner">
      <div class="col-lg-6">
        ...
        <div class="single-prd-item">
          <img class="img-fluid" src="admin/images/<?php echo $result['image'] ?>" width='500' alt="<?php echo $result['name'] ?>">
        </div>
        ...
        <div class="s_product_text">
          ...
          <form action="addtocart.php" method="post">
            ...
            <div class="card_area d-flex align-items-center">
              ...
              <a href="index.php" class="primary-btn" title="Back"><i class="fa fa-arrow-left"></i></a>
            </div>
          </form>
        </div>
      </div>
