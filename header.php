	...
	<section class="banner-area organic-breadcrumb" style="margin-bottom:0">
		<div class="container">
			<div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
				<div class="col-first">
					<h1>Welcome <?php echo !empty($_SESSION['username']) ? $_SESSION['username'] : (!empty($_SESSION['user_name']) ? $_SESSION['user_name'] : "Errorrrrrrrrrrrr!") ?></h1>
					<a href="logout.php" class="primary-btn" style="color: black;line-height: 30px;background: white;">
						Logout
					</a>
				</div>
			</div>
